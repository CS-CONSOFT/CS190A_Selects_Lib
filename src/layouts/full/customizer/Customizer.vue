...
<template>
    <div class="pa-6">
        <h5 class="text-h5">Configurações</h5>
    </div>
    <v-divider></v-divider>
    <perfect-scrollbar style="height: calc(100vh - 90px)">
        <div class="pa-6">
            ...
            <!------Theme Direction------>
            <h6 class="text-h6 mt-8 mb-5">Direção do Tema</h6>
            ...
            <h6 class="text-h6 mt-8 mb-5">Cor do Tema</h6>
            ...
            <h6 class="text-h6 mt-11 mb-5">Cor do Tema Dark</h6>
            <v-item-group mandatory v-model="customizer.actTheme" class="ml-n2 v-row">
            ...
            <h6 class="text-h6 mt-11 mb-2">Opções de Container</h6>
            ...
            <v-sheet v-if="customizer.setHorizontalLayout != true">
                <h6 class="text-h6 mt-11 mb-2">Tipo de Barra lateral</h6>
            ...
            <h6 class="text-h6 mt-11 mb-2">Card com</h6>
